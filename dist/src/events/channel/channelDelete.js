...
exports.channelDelete = {
    ...
    run: (client, channel) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const event = "channelDelete", startAt = Date.now();
        try {
            channel.guild.fetchAuditLogs({ type: client.actionType["channelDelete"].id, limit: 10 }).then((audit) => audit.entries.first()).then((entry) => __awaiter(void 0, void 0, void 0, function* () {
