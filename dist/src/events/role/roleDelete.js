...
exports.roleDelete = {
    ...
    run: (client, role) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            role.guild.fetchAuditLogs({ type: client.actionType["roleDelete"].id, limit: 10 }).then((audit) => audit.entries.first()).then((entry) => __awaiter(void 0, void 0, void 0, function* () {
